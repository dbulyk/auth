...
type UserRepositoryMock struct {
	...
	funcCreateUser          func(ctx context.Context, in *model.CreateUserRequest) (i1 int64, err error)
	funcCreateUserOrigin    string
	inspectFuncCreateUser   func(ctx context.Context, in *model.CreateUserRequest)
	...
	funcGetUser          func(ctx context.Context, userID int64) (gp1 *model.GetUserResponse, err error)
	...
	funcUpdateUser          func(ctx context.Context, in *model.UpdateUserRequest) (err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, in *model.UpdateUserRequest)
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, in *model.CreateUserRequest) *mUserRepositoryMockCreateUser {
	...
	mmCreateUser.defaultExpectation.params = &UserRepositoryMockCreateUserParams{ctx, in}
...
// ExpectInParam2 sets up expected param in for UserRepository.CreateUser
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectInParam2(in *model.CreateUserRequest) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
	...
	mmCreateUser.defaultExpectation.expectationOrigins.originIn = minimock.CallerInfo(1)

	return mmCreateUser
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.CreateUser
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, in *model.CreateUserRequest)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, in *model.CreateUserRequest) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, in *model.CreateUserRequest) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateUserExpectation{
		...
		params:             &UserRepositoryMockCreateUserParams{ctx, in},
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, in *model.CreateUserRequest) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateUserParams{ctx, in}
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateUserParams{ctx, in}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmCreateUser.t.Errorf("UserRepositoryMock.CreateUser got unexpected parameter in, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateUser.CreateUserMock.defaultExpectation.expectationOrigins.originIn, *mm_want_ptrs.in, mm_got.in, minimock.Diff(*mm_want_ptrs.in, mm_got.in))
			}
	...
	mmCreateUser.t.Fatalf("Unexpected call to UserRepositoryMock.CreateUser. %v %v", ctx, in)
	return
}
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Set(f func(ctx context.Context, userID int64) (err error)) *UserRepositoryMock {
	if mmDeleteUser.defaultExpectation != nil {
...
func (mmDeleteUser *UserRepositoryMock) DeleteUser(ctx context.Context, userID int64) (err error) {
...
func (mmGetUser *mUserRepositoryMockGetUser) Return(gp1 *model.GetUserResponse, err error) *UserRepositoryMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
	...
	mmGetUser.defaultExpectation.results = &UserRepositoryMockGetUserResults{gp1, err}
...
func (mmGetUser *mUserRepositoryMockGetUser) Set(f func(ctx context.Context, userID int64) (gp1 *model.GetUserResponse, err error)) *UserRepositoryMock {
	if mmGetUser.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetUserExpectation) Then(gp1 *model.GetUserResponse, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetUserResults{gp1, err}
	return e.mock
}
...
func (mmGetUser *UserRepositoryMock) GetUser(ctx context.Context, userID int64) (gp1 *model.GetUserResponse, err error) {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Expect(ctx context.Context, in *model.UpdateUserRequest) *mUserRepositoryMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserRepositoryMockUpdateUserParams{ctx, in}
...
// ExpectInParam2 sets up expected param in for UserRepository.UpdateUser
func (mmUpdateUser *mUserRepositoryMockUpdateUser) ExpectInParam2(in *model.UpdateUserRequest) *mUserRepositoryMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	mmUpdateUser.defaultExpectation.paramPtrs.in = &in
	mmUpdateUser.defaultExpectation.expectationOrigins.originIn = minimock.CallerInfo(1)

	return mmUpdateUser
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.UpdateUser
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Inspect(f func(ctx context.Context, in *model.UpdateUserRequest)) *mUserRepositoryMockUpdateUser {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Set(f func(ctx context.Context, in *model.UpdateUserRequest) (err error)) *UserRepositoryMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserRepositoryMockUpdateUser) When(ctx context.Context, in *model.UpdateUserRequest) *UserRepositoryMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateUserExpectation{
		...
		params:             &UserRepositoryMockUpdateUserParams{ctx, in},
...
func (mmUpdateUser *UserRepositoryMock) UpdateUser(ctx context.Context, in *model.UpdateUserRequest) (err error) {
	...
	if mmUpdateUser.inspectFuncUpdateUser != nil {
		mmUpdateUser.inspectFuncUpdateUser(ctx, in)
	}

	mm_params := UserRepositoryMockUpdateUserParams{ctx, in}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateUserParams{ctx, in}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmUpdateUser.t.Errorf("UserRepositoryMock.UpdateUser got unexpected parameter in, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUpdateUser.UpdateUserMock.defaultExpectation.expectationOrigins.originIn, *mm_want_ptrs.in, mm_got.in, minimock.Diff(*mm_want_ptrs.in, mm_got.in))
			}
	...
	if mmUpdateUser.funcUpdateUser != nil {
		return mmUpdateUser.funcUpdateUser(ctx, in)
	}
	mmUpdateUser.t.Fatalf("Unexpected call to UserRepositoryMock.UpdateUser. %v %v", ctx, in)
	return
}
