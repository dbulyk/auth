...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, in *model.CreateUserRequest) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, in *model.CreateUserRequest)
	...
	funcGet          func(ctx context.Context, userID int64) (gp1 *model.GetUserResponse, err error)
	...
	funcUpdate          func(ctx context.Context, in *model.UpdateUserRequest) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, in *model.UpdateUserRequest)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, in *model.CreateUserRequest) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, in}
...
// ExpectInParam2 sets up expected param in for UserService.Create
func (mmCreate *mUserServiceMockCreate) ExpectInParam2(in *model.CreateUserRequest) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, in *model.CreateUserRequest)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, in *model.CreateUserRequest) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, in *model.CreateUserRequest) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserServiceMockCreateParams{ctx, in},
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, in *model.CreateUserRequest) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateParams{ctx, in}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, in}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmCreate.t.Errorf("UserServiceMock.Create got unexpected parameter in, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, in)
	return
}
...
// ExpectUserIDParam2 sets up expected param userID for UserService.Delete
func (mmDelete *mUserServiceMockDelete) ExpectUserIDParam2(userID int64) *mUserServiceMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmDelete.t.Errorf("UserServiceMock.Delete got unexpected parameter userID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
// ExpectUserIDParam2 sets up expected param userID for UserService.Get
func (mmGet *mUserServiceMockGet) ExpectUserIDParam2(userID int64) *mUserServiceMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Return(gp1 *model.GetUserResponse, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &UserServiceMockGetResults{gp1, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the UserService.Get method
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, userID int64) (gp1 *model.GetUserResponse, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(gp1 *model.GetUserResponse, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{gp1, err}
	return e.mock
}
...
func (mmGet *UserServiceMock) Get(ctx context.Context, userID int64) (gp1 *model.GetUserResponse, err error) {
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmGet.t.Errorf("UserServiceMock.Get got unexpected parameter userID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, in *model.UpdateUserRequest) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, in}
...
// ExpectInParam2 sets up expected param in for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectInParam2(in *model.UpdateUserRequest) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, in *model.UpdateUserRequest)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, in *model.UpdateUserRequest) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, in *model.UpdateUserRequest) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserServiceMockUpdateParams{ctx, in},
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, in *model.UpdateUserRequest) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, in}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, in}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter in, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, in)
	return
}
